...
enum {
  ...
  aux_sym__statement_repeat1 = 49,
  aux_sym_func_repeat1 = 50,
  aux_sym_block_repeat1 = 51,
  aux_sym_string_repeat1 = 52,
  aux_sym_with_expr_repeat1 = 53,
  aux_sym_type_definition_repeat1 = 54,
  aux_sym_type_definition_repeat2 = 55,
};
